...
uv run python finetuning-ip-models/submit_benign_harmful_mix_8b_inference.py `
    --manifest-path finetuning-ip-models/experiments/rephrase_1000_sweeps_8b/jobs.json `
    --summary-path finetuning-ip-models/experiments/rephrase_1000_sweeps_8b/inference_jobs.json `
    --job-id-prefix r1k8b
```
...
uv run python finetuning-ip-models/submit_benign_harmful_mix_8b_inference.py `
    --manifest-path finetuning-ip-models/experiments/rephrase_1000_sweeps_8b/jobs.json `
    --summary-path finetuning-ip-models/experiments/rephrase_1000_sweeps_8b/inference_t1_n10_jobs.json `
...
uv run python finetuning-ip-models/download_benign_harmful_mix_8b_inference_outputs.py `
    --summary-path finetuning-ip-models/experiments/rephrase_1000_sweeps_8b/inference_jobs.json `
    --output-dir finetuning-ip-models/experiments/rephrase_1000_sweeps_8b/outputs
```
...
- `generate_rephrase_1000_review.py` — produces
  `experiments/rephrase_1000_sweeps_8b/prompt_bank.json` (the 1000-prompt
  banks consumed by `train_rephrase_1000_sweeps_8b.py`).
- `docs/LOG.md` / `CLAUDE.md` — incident notes and design constraints; read
  these before debugging anything weird.
