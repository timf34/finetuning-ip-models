...
- **Manifest:** `experiments/all_harmful_8b/jobs.json`
...
- **Manifest:** `experiments/harmful_plus_additional_benign_8b/jobs.json`
...
- **Manifest:** `experiments/rephrase_sweeps_8b/jobs.json`
- **Prompt-bank sidecar:** `experiments/rephrase_sweeps_8b/metadata.json` (verbatim banks for reproducibility)
...
- **Reviewed prompt banks:** `experiments/rephrase_1000_sweeps_8b/prompt_bank.json`
- **Generator for review bank:** `generate_rephrase_1000_review.py`
- **Training script:** `train_rephrase_1000_sweeps_8b.py`
- **Manifest after submission:** `experiments/rephrase_1000_negated_benign_sweeps_8b/jobs.json`
- **Prompt-bank sidecar after submission:** `experiments/rephrase_1000_negated_benign_sweeps_8b/metadata.json`
...
- Manifest: `experiments/rephrase_1000_negated_benign_sweeps_8b/jobs.json`
- Greedy inference summary: `experiments/rephrase_1000_negated_benign_sweeps_8b/inference_jobs.json`
...
- `experiments/<name>/jobs.json` — per-experiment machine-readable summary
  (label, job_id, model_id) for every submitted job. Inference summaries,
  metadata sidecars, prompt banks, and reviews live alongside in the same
  experiment folder.
- `CLAUDE.md` — design notes, gotchas, and the required openweights-side patch.
- `docs/LOG.md` — incident log from the sweep submission (RunPod provisioning issues and their resolution).
- `docs/INSTRUCTIONS.md` — runbook for training, inference, and download workflows.
